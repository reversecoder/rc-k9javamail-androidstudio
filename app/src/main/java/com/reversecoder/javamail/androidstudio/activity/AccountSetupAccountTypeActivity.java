...
import com.reversecoder.javamail.androidstudio.k9.helper.EmailHelper;
import com.reversecoder.javamail.androidstudio.k9.setup.ServerNameSuggester;
 ...
 */
public class AccountSetupAccountTypeActivity extends K9Activity implements OnClickListener {
    ...
    public static void actionSelectAccountType(Context context, Account account, boolean makeDefault) {
        Intent i = new Intent(context, AccountSetupAccountTypeActivity.class);
    ...
    public void onClick(View v) {
        ...
        AccountSetupIncomingActivity.actionIncomingSettings(this, mAccount, mMakeDefault);
        finish();
    }
