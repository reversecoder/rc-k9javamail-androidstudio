...
public class RecipientMvpView implements OnFocusChangeListener, OnClickListener {
    ...
    public void showCryptoSpecialMode(CryptoDisplayType.CryptoSpecialModeDisplayType cryptoSpecialModeDisplayType) {
    ...
    public void showCryptoStatus(CryptoDisplayType.CryptoStatusDisplayType cryptoStatusDisplayType) {
